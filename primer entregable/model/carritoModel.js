...
class CarritoModel{
    ...
    static addProductos(idCarrito, productos){
        ...
        const productosHabilitados = ProductoController.getByID();
    ...
    static deleteProducto(idCarrito,idProducto){
        const rta = {error:true,msg:''};
